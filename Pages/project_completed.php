...
$completedOrdersSql = "SELECT * FROM orders WHERE seller_username = '$displayName' AND project_status = 'completed' ORDER BY id DESC";
    ...
    <div class="row">
        <div class="col-12">
            <div class="custom-square">
                <h5 class="square1">Completed Projects : <?php echo $completedOrderCount; ?></h5>
                <?php
                while ($row = mysqli_fetch_assoc($completedOrdersResult)) {
                    ...
                    echo '<p><strong>Completed on:</strong> '  . $row['completed_timestamp'] . '</p>';
