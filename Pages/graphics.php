...
<body style="height: 2000px;">
    ...
    <div id="overlay-container" style="margin-top: 20px;">
        <img id="background-image" src="img/graphic texture.jpg"></img>
        <div id="overlay-content">
            <div id="title"> <strong>Graphics & Design </strong><br> <i>Designs to make you stand out.</i></div>
        </div>
    </div><br><br>

    <h5><i>available services in graphic & design</i></h5>
