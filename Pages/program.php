...
$serviceCategory = 'Programming & Tech';
...
<body style="height: 2000px;">
    ...
    <img id="background-image" src="img/programming texture.jpg" ></img>
        <div id="overlay-content">
            <div id="title"> <strong>Programming & Tech </strong><br> <i>You think it. A programmer develops it.</i></div>
            </div>
            </div><br><br>

            <h5><i>available services in programming & tech</i></h5>
