...
<body style="height: 2000px;">
    ...
    <img id="background-image" src="img/music texture.jpg" ></img>
        <div id="overlay-content">
            <div id="title"> <strong>Music & Audio</strong><br> <i>Don't miss a beat. Bring your sound to life. </i></div>
            </div>
            </div><br><br>

            <h5><i>available services in music & audio</i></h5>
