...
$serviceCategory = 'Writing & Translation';
...
<body style="height: 2000px;">
    ...
    <img id="background-image" src="img/writing texture.jpg" ></img>
        <div id="overlay-content">
            <div id="title"> <strong>Writing & Translation </strong><br> <i>Get your words across—in any language.</i></div>
            </div>
            </div><br><br>

            <h5><i>available services in writing & translation</i></h5>
